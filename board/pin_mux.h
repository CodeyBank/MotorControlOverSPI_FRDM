...
/* Symbols to be used with GPIO driver */
#define NCN_PERIPHERAL_INIT_PCS_Pin_GPIO GPIO0                /*!<@brief GPIO peripheral base pointer */
#define NCN_PERIPHERAL_INIT_PCS_Pin_GPIO_PIN 19U              /*!<@brief GPIO pin number */
#define NCN_PERIPHERAL_INIT_PCS_Pin_GPIO_PIN_MASK (1U << 19U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define NCN_PERIPHERAL_INIT_PCS_Pin_PORT PORT0                /*!<@brief PORT peripheral base pointer */
#define NCN_PERIPHERAL_INIT_PCS_Pin_PIN 19U                   /*!<@brief PORT pin number */
#define NCN_PERIPHERAL_INIT_PCS_Pin_PIN_MASK (1U << 19U)      /*!<@brief PORT pin mask */
                                                              /* @} */

/*! @name PORT0_20 (coord C8), P0_20/SJ24[3]/J7[2]
  @{ */

/* Symbols to be used with GPIO driver */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_GPIO GPIO0                /*!<@brief GPIO peripheral base pointer */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_GPIO_PIN 20U              /*!<@brief GPIO pin number */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_GPIO_PIN_MASK (1U << 20U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_PORT PORT0                /*!<@brief PORT peripheral base pointer */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_PIN 20U                   /*!<@brief PORT pin number */
#define NCN_PERIPHERAL_INIT_IRQ_Pin_PIN_MASK (1U << 20U)      /*!<@brief PORT pin mask */
                                                              /* @} */
...
/* Symbols to be used with GPIO driver */
#define NCN_PERIPHERAL_INIT_RESET_Pin_GPIO GPIO5               /*!<@brief GPIO peripheral base pointer */
#define NCN_PERIPHERAL_INIT_RESET_Pin_GPIO_PIN 6U              /*!<@brief GPIO pin number */
#define NCN_PERIPHERAL_INIT_RESET_Pin_GPIO_PIN_MASK (1U << 6U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define NCN_PERIPHERAL_INIT_RESET_Pin_PORT PORT5               /*!<@brief PORT peripheral base pointer */
#define NCN_PERIPHERAL_INIT_RESET_Pin_PIN 6U                   /*!<@brief PORT pin number */
#define NCN_PERIPHERAL_INIT_RESET_Pin_PIN_MASK (1U << 6U)      /*!<@brief PORT pin mask */
                                                               /* @} */
