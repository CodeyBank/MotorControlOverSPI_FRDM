...
- {pin_num: C8, pin_signal: PIO0_20/WUU0_IN4/FC0_P4/FC1_P0/CT_INP0/FLEXIO0_D4/I3C0_SDA/TSI0_CH15/ADC0_A12, label: 'P0_20/SJ24[3]/J7[2]', identifier: IRQ_Pin}
...
- {pin_num: C9, pin_signal: PIO0_19/WUU0_IN3/EWM0_OUT_b/FC0_P3/CT0_MAT3/FLEXIO0_D3/HSCMP1_OUT/TSI0_CH14/ADC0_A11, label: 'P0_19/J2[13]/J7[1]', identifier: PCS_Pin}
...
- {pin_num: K13, pin_signal: PIO5_6/TRIG_OUT6/LPTMR1_ALT2/TAMPER4/ADC1_B14, label: 'P5_6/SJ13[1]', identifier: RESET_Pin}
...
- {pin_num: M15, pin_signal: PIO3_23/FC6_P3/CT_INP11/PWM1_X3/FLEXIO0_D31/SAI1_TXD1, label: 'P3_23/J6[3]', identifier: TESTIRQ}
...
- options: {callFromInitBoot: 'true', coreID: cm33_core0, enableClock: 'true'}
- pin_list:
  - {pin_num: D15, peripheral: CTIMER4, signal: 'MATCH, 0', pin_signal: PIO3_2/FC7_P0/CT4_MAT0/PWM0_X0/FLEXIO0_D10/SIM1_PD}
  ...
  - {pin_num: C8, peripheral: GPIO0, signal: 'GPIO, 20', pin_signal: PIO0_20/WUU0_IN4/FC0_P4/FC1_P0/CT_INP0/FLEXIO0_D4/I3C0_SDA/TSI0_CH15/ADC0_A12, direction: INPUT,
    gpio_per_interrupt: kGPIO_InterruptFallingEdge, open_drain: disable, drive_strength: high, pull_select: up, pull_enable: enable, pull_value: high}
  - {pin_num: K13, peripheral: GPIO5, signal: 'GPIO, 6', pin_signal: PIO5_6/TRIG_OUT6/LPTMR1_ALT2/TAMPER4/ADC1_B14, direction: OUTPUT, gpio_init_state: 'true', open_drain: enable}
  ...
  - {pin_num: C10, peripheral: LP_FLEXCOMM0, signal: LPFLEXCOMM_P2, pin_signal: PIO0_18/EWM0_IN/FC0_P2/CT0_MAT2/FLEXIO0_D2/HSCMP0_OUT/PDM0_DATA1/TSI0_CH13/ADC0_A10}
  - {pin_num: G13, peripheral: LP_FLEXCOMM0, signal: LPFLEXCOMM_P3, pin_signal: PIO0_15/FC0_P3/CT_INP3/UTICK_CAP1/FLEXIO0_D7/ADC0_B15}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : NCN_Peripheral_Init
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/
void NCN_Peripheral_Init(void)
{
    ...
    gpio_pin_config_t PCS_Pin_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PIO0_19 (pin C9)  */
    GPIO_PinInit(NCN_PERIPHERAL_INIT_PCS_Pin_GPIO, NCN_PERIPHERAL_INIT_PCS_Pin_PIN, &PCS_Pin_config);

    gpio_pin_config_t IRQ_Pin_config = {
        .pinDirection = kGPIO_DigitalInput,
        .outputLogic = 0U
    };
    /* Initialize GPIO functionality on pin PIO0_20 (pin C8)  */
    GPIO_PinInit(NCN_PERIPHERAL_INIT_IRQ_Pin_GPIO, NCN_PERIPHERAL_INIT_IRQ_Pin_PIN, &IRQ_Pin_config);
    ...
    GPIO_PinInit(NCN_PERIPHERAL_INIT_RESET_Pin_GPIO, NCN_PERIPHERAL_INIT_RESET_Pin_PIN, &RESET_Pin_config);

    /* Interrupt configuration on GPIO0_20 (pin C8): Interrupt on falling edge */
    GPIO_SetPinInterruptConfig(NCN_PERIPHERAL_INIT_IRQ_Pin_GPIO, NCN_PERIPHERAL_INIT_IRQ_Pin_PIN, kGPIO_InterruptFallingEdge);

    /* PORT0_15 (pin G13) is configured as FC0_P3 */
    PORT_SetPinMux(PORT0, 15U, kPORT_MuxAlt3);
    ...
    /* PORT0_18 (pin C10) is configured as FC0_P2 */
    PORT_SetPinMux(PORT0, 18U, kPORT_MuxAlt2);
    ...
    PORT_SetPinMux(NCN_PERIPHERAL_INIT_PCS_Pin_PORT, NCN_PERIPHERAL_INIT_PCS_Pin_PIN, kPORT_MuxAlt0);
    ...
    PORT_SetPinMux(NCN_PERIPHERAL_INIT_IRQ_Pin_PORT, NCN_PERIPHERAL_INIT_IRQ_Pin_PIN, kPORT_MuxAlt0);

    PORT0->PCR[20] =
        ((PORT0->PCR[20] &
          /* Mask bits to zero which are setting */
          (~(PORT_PCR_PS_MASK | PORT_PCR_PE_MASK | PORT_PCR_PV_MASK | PORT_PCR_ODE_MASK | PORT_PCR_DSE_MASK | PORT_PCR_IBE_MASK)))
    ...
    PORT_SetPinMux(PORT3, 2U, kPORT_MuxAlt4);
    ...
    PORT5->PCR[6] = ((PORT5->PCR[6] &
                      /* Mask bits to zero which are setting */
                      (~(PORT_PCR_ODE_MASK | PORT_PCR_MUX_MASK | PORT_PCR_IBE_MASK)))
